...
export interface Config {
  ...
  globalsSelect: {
    ...
    createAccount: CreateAccountSelect<false> | CreateAccountSelect<true>;
    findOrder: FindOrderSelect<false> | FindOrderSelect<true>;
    forgotPassword: ForgotPasswordSelect<false> | ForgotPasswordSelect<true>;
  };
  locale: null;
  user: User & {
    collection: 'users';
...
export interface CallToActionBlock {
  ...
  links?:
    | {
        link: {
          type?: ('reference' | 'custom' | 'internalCustom') | null;
          newTab?: boolean | null;
          reference?: {
            relationTo: 'pages';
            value: string | Page;
...
export interface Page {
  ...
  title: string;
  /**
   * Select products to feature on this page (e.g., for "just-arrived" page)
   */
...
export interface Main {
  ...
  contentImageSplitTitle: string;
  contentImageSplitContent: string;
  contentImageSplitButton: {
    text: string;
    link?: {
      type?: ('reference' | 'custom' | 'internalCustom') | null;
      newTab?: boolean | null;
  ...
  contentImageSplitImage: string | Media;
  updatedAt?: string | null;
  createdAt?: string | null;
}
/**
...
export interface Login {
  id: string;
  sideMedia?: (string | null) | Media;
  updatedAt?: string | null;
  createdAt?: string | null;
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "createAccount".
 */
...
export interface MainSelect<T extends boolean = true> {
  ...
  contentImageSplitTitle?: T;
  contentImageSplitContent?: T;
  contentImageSplitButton?:
    | T
    | {
        text?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "createAccount_select".
 */
export interface CreateAccountSelect<T extends boolean = true> {
  sideMedia?: T;
  updatedAt?: T;
  createdAt?: T;
  globalType?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "findOrder_select".
 */
export interface FindOrderSelect<T extends boolean = true> {
  sideMedia?: T;
  updatedAt?: T;
  createdAt?: T;
  globalType?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "forgotPassword_select".
 */
export interface ForgotPasswordSelect<T extends boolean = true> {
  sideMedia?: T;
  updatedAt?: T;
  createdAt?: T;
  globalType?: T;
